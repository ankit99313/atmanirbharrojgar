...
public class PhotoUpload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sstorageReference = rstorage.child("Images").child("UsersImages");
        skip = (TextView) findViewById(R.id.skip);

        skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PhotoUpload.this, AccountType.class);
    ...
    public void uploadimage(View v) throws IOException {
        ...
        if (filepath != null) {
            ...
            // uploadTask2.putFile(filepath).addOnSuccessListener(taskSnapshot -> {
            uploadTask2.addOnSuccessListener(taskSnapshot -> {
                ...
                result.addOnSuccessListener(uri -> {
                    ...
                    // FirebaseDatabase.getInstance().getReference("Users").child(ruserid).child("urlToImage").setValue(urlToImage);
                ...
                if (gg.equals("work")) {
                    Intent intent = new Intent(PhotoUpload.this, WorkMain.class);
                    startActivity(intent);
                    finish();
                } else if (gg.equals("hire")) {
                    Intent intent = new Intent(PhotoUpload.this, HireMain.class);
                    startActivity(intent);
                    finish();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (requestCode == SELECT_PICTURE) {
                // Bitmap fullsizeBitmap= BitmapFactory.decodeFile();
