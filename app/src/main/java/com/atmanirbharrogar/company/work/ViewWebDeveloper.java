...
public class ViewWebDeveloper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_web_developer);
        ...
        searchList.setLayoutManager(new LinearLayoutManager(ViewWebDeveloper.this));
        ...
        btnLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(ViewWebDeveloper.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    getLocation();
                } else {
                    ActivityCompat.requestPermissions(ViewWebDeveloper.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
                }
            }
        });
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        Geocoder geocoder = new Geocoder(ViewWebDeveloper.this, Locale.getDefault());
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.getValue() != null) {
                            ...
                            FirebaseRecyclerOptions<Person> options =
                                    new FirebaseRecyclerOptions.Builder<Person>()
                                            .setQuery(reference.orderByChild("Profession").equalTo("Web_Developer"), Person.class)
