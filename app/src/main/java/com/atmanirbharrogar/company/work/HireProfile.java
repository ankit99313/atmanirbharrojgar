...
public class HireProfile extends AppCompatActivity {
    FirebaseAuth mAuth;
    DatabaseReference mDatabase, msubref;
    ImageView image;
    TextView name, LandMark, aadhaar, mobile, state, city, address;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hire_profile);
    ...
    public void edit_recruiter(View v) {
        startActivity(new Intent(HireProfile.this, HireEdit.class));
    }
}