...
public class ViewAndroidDeveloper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_android_developer);
        ...
        searchList.setLayoutManager(new LinearLayoutManager(ViewAndroidDeveloper.this));
        ...
        btnLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(ViewAndroidDeveloper.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    getLocation();
                } else {
                    ActivityCompat.requestPermissions(ViewAndroidDeveloper.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
                }
            }
        });
    }
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        Geocoder geocoder = new Geocoder(ViewAndroidDeveloper.this, Locale.getDefault());
                       ...
                       // DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Users/Android_Developer");
                 ...
                 .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.getValue() != null) {
                            ...
                            //  Toast.makeText(ViewAndroidDeveloper.this, "hiii", Toast.LENGTH_SHORT).show();
                            ...
                            FirebaseRecyclerOptions<Person> options =
                                    new FirebaseRecyclerOptions.Builder<Person>()
                                            ...
                                            .setQuery(reference.orderByChild("Profession").equalTo("Android_Developer"), Person.class)
                                            //.setQuery(FirebaseDatabase.getInstance().getReference().child("Users").orderByChild("Profession").equalTo("Android_Developer").orderByChild("City").startAt(SearchInput).endAt(SearchInput + "\uf8ff"), Person.class)
                                            .build();
