                ...
                .addOnCompleteListener(phoneverify.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            User u = new User( getIntent().getExtras().getString("mobile"));
                            ...
                            userRef
                                    .orderByChild("Mobile")
                                    .equalTo(u.getContact_Number())
                                    .addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                            if (dataSnapshot.getValue() != null) {
                                                //it means user already registered
                                                Intent intent = new Intent(phoneverify.this, RecruiterMain.class);
                                                ...
                                                //intent.putExtra("phonenumber", u.getContact_Number());
                                                intent.putExtra("mobile", getIntent().getExtras().getString("mobile"));
                                                startActivity(intent);
                                                finish();
                                            }
