...
public class HireEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hire_edit);
        ...
        profile.setOnClickListener(v -> startActivity(new Intent(HireEdit.this, PhotoUpload.class)));
