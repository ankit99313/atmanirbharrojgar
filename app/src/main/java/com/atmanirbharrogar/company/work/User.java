...
public User(String email,String id,String street_No,String pincode,String state,String city,String gender,String profession,String type,String name,String alternate_Contact_Number){
    Email = email;
    Id = id;
    Street_No = street_No;
    Pincode = pincode;
