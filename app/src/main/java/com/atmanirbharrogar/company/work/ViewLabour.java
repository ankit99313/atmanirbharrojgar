...
public class ViewLabour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList.setLayoutManager(new LinearLayoutManager(ViewLabour.this));
        ...
        btnLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(ViewLabour.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    getLocation();
                } else {
                    ActivityCompat.requestPermissions(ViewLabour.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
                }
            }
        });
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        Geocoder geocoder = new Geocoder(ViewLabour.this, Locale.getDefault());
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.getValue() != null) {
                            ...
                            FirebaseRecyclerOptions<Person> options =
                                    new FirebaseRecyclerOptions.Builder<Person>()
                                            .setQuery(reference.orderByChild("Profession").equalTo("Labour"), Person.class)
