...
public class TutorView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList.setLayoutManager(new LinearLayoutManager(TutorView.this));
        ...
        btnLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(TutorView.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    getLocation();
                } else {
                    ActivityCompat.requestPermissions(TutorView.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
                }
            }
        });
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        Geocoder geocoder = new Geocoder(TutorView.this, Locale.getDefault());
                        ...
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Seeker/Tutor");
