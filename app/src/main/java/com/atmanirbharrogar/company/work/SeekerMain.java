...
public class SeekerMain extends AppCompatActivity implements DuoMenuView.OnMenuClickListener {
    ...
    public void onOptionClicked(int position, Object objectClicked) {
      ...
      //  MenuAdapter.setViewSelected(position , true);
        ...
        switch (position) {
            case 3:
                startActivity(new Intent(SeekerMain.this, RecruiterMain.class));
                finish();
                break;
            case 2:
    ...
    public void dothis(View v) {
        switch (v.getId()) {
            ...
            case R.id.android_developer:
                Toast.makeText(getApplicationContext(), "Android Developer", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.generalsurgeon:
                Toast.makeText(getApplicationContext(), "General Surgeon", Toast.LENGTH_SHORT).show();
                break;
